...
public class GifDecoder extends Thread {
  ...
  /**
   * whether the deocode is success
   * 
  ...
  /**
   * get the numbers of frames
   * 
   * @return the count of the pic frames
   */
  ...
  /**
   * get the frame picture
   * 
   * @return the current frame pic
   */
   ...
   * getCurrentFrame
   * 
   * @return get the next frame
   */
  public GifFrame next() {
    if (mPostion == getFrameCount() - 1) {
      mPostion = 0;
    }
    mPostion++;
    if (isShow == false) {
