...
UpnpString *UpnpString_new()
{
	...
	struct SUpnpString *p = (struct SUpnpString*)calloc((size_t)1, sizeof (struct SUpnpString));
	if (p == NULL) {
		goto error_handler1;
	}
#if 0
...
{
	struct SUpnpString *q = (struct SUpnpString*)calloc((size_t)1, sizeof (struct SUpnpString));
	if (q == NULL) {
		goto error_handler1;
	}
