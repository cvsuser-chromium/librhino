...
#if 1
//#define Log_Printf(level, FmtStr...)	HT_DBG_PRINTF(HT_MOD_DMC, HT_BIT_MYRIAD, FmtStr)
//#define Log_Print(level, msg)			Log_Printf(level, msg)
#define Log_Printf(level, FmtStr...)	{};
#define Log_Print(level, msg)			{};

#else

#define Log_Printf(level, FmtStr...)	HT_Printf(HT_MOD_DMC, HT_BIT_DEBUG, __FILE__, __LINE__, __FUNCTION__, FmtStr)
#define Log_Print(level, msg)			Log_Printf(level, msg)
#endif
