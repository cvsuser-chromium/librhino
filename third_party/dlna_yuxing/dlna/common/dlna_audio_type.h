#ifndef _DLNA_AUDIO_TYPE_H_
#define _DLNA_AUDIO_TYPE_H_
...
#define  WAVE_FORMAT_WMA_AUDIO			0x3000 /* FAST Multimedia AG */

#define SET_WAVE_FORMAT(x)		(x = WAVE_FORMAT_ADPCM)
#define IS_WAVE_FORMAT_LPCM(x)	(WAVE_FORMAT_ADPCM==x)

#endif /* _DLNA_AUDIO_TYPE_H_ */
