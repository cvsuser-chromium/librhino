 ...
 *****************************************************************************/
dvbpsi_handle DMA_dvbpsi_AttachPAT(dvbpsi_pat_callback pf_callback,
                               void* p_cb_data)
{
  ...
  h_dvbpsi->pf_callback = &DMA_dvbpsi_GatherPATSections;
 ...
 *****************************************************************************/
void DMA_dvbpsi_DetachPAT(dvbpsi_handle h_dvbpsi)
{
  dvbpsi_pat_decoder_t* p_pat_decoder
 ...
 *****************************************************************************/
void DMA_dvbpsi_InitPAT(dvbpsi_pat_t* p_pat, unsigned short i_ts_id, unsigned char i_version,
                    int b_current_next)
{
 ...
 *****************************************************************************/
void DMA_dvbpsi_EmptyPAT(dvbpsi_pat_t* p_pat)
{
 ...
 *****************************************************************************/
dvbpsi_pat_program_t* DMA_dvbpsi_PATAddProgram(dvbpsi_pat_t* p_pat,
                                           unsigned short i_number, unsigned short i_pid)
{
 ...
 *****************************************************************************/
void DMA_dvbpsi_GatherPATSections(dvbpsi_decoder_t* p_decoder,
                              dvbpsi_psi_section_t* p_section)
{
  ...
  if(b_reinit)
  {
    ...
    for(i = 0; i <= 255; i++)
    {
      ...
      {
       DMA_dvbpsi_DeletePSISections(p_pat_decoder->ap_sections[i]);
        p_pat_decoder->ap_sections[i] = NULL;
      }
    }
  }
  ...
  if(b_append)
  {
    ...
    if(!p_pat_decoder->p_building_pat)
    {
      ...
      DMA_dvbpsi_InitPAT(p_pat_decoder->p_building_pat,
    ...
    {
#if 0
      DMA_DVBPSI_DEBUG_ARG("PAT decoder", "overwrite section number %d",
                       p_section->i_number);
#endif
      DMA_dvbpsi_DeletePSISections(p_pat_decoder->ap_sections[p_section->i_number]);
    }
    ...
    if(b_complete)
    {
      ...
      /* Decode the sections */
      DMA_dvbpsi_DecodePATSections(p_pat_decoder->p_building_pat,
                               p_pat_decoder->ap_sections[0]);
      /* Delete the sections */
      DMA_dvbpsi_DeletePSISections(p_pat_decoder->ap_sections[0]);
      /* signal the new PAT */
 ...
 * PAT decoder.
 *****************************************************************************/
void DMA_dvbpsi_DecodePATSections(dvbpsi_pat_t* p_pat,
                               dvbpsi_psi_section_t* p_section)
{
  ...
  while(p_section)
  {
    for(p_byte = p_section->p_payload_start;
        ...
        p_byte += 4)
    {
      unsigned short i_program_number = ((unsigned short)(p_byte[0]) << 8) | p_byte[1];
      unsigned short i_pid = ((unsigned short)(p_byte[2] & 0x1f) << 8) | p_byte[3];
      DMA_dvbpsi_PATAddProgram(p_pat, i_program_number, i_pid);
    }
 ...
 *****************************************************************************/
dvbpsi_psi_section_t* DMA_dvbpsi_GenPATSections(dvbpsi_pat_t* p_pat,
                                            int i_max_pps)
{
