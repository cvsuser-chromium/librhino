 ...
 *****************************************************************************/
static unsigned int DMA_s_crc32_table[256] =
{
...
/*****************************************************************************
 * DMA_dvbpsi_NewPSISection
 *****************************************************************************
 * Creation of a new dvbpsi_psi_section_t structure.
 *****************************************************************************/
dvbpsi_psi_section_t * DMA_dvbpsi_NewPSISection(int i_max_size)
{
  ...
  if(p_section != NULL)
  {
    ...
    p_section->p_data = (unsigned char*)malloc(i_max_size * sizeof(unsigned char));
...
/*****************************************************************************
 * DMA_dvbpsi_DeletePSISections
 *****************************************************************************
 * Destruction of a dvbpsi_psi_section_t structure.
 *****************************************************************************/
void DMA_dvbpsi_DeletePSISections(dvbpsi_psi_section_t * p_section)
{
...
/*****************************************************************************
 * DMA_dvbpsi_ValidPSISection
 *****************************************************************************
 * Check the CRC_32 if the section has b_syntax_indicator set.
 *****************************************************************************/
int DMA_dvbpsi_ValidPSISection(dvbpsi_psi_section_t* p_section)
{
  return 1;
  if(p_section->b_syntax_indicator)
  {
    ...
    {
      i_crc = (i_crc << 8) ^ DMA_s_crc32_table[(i_crc >> 24) ^ (*p_byte)];
      p_byte++;
    }
 ...
 *****************************************************************************/
void DMA_dvbpsi_BuildPSISection(dvbpsi_psi_section_t* p_section)
{
  unsigned char* p_byte = p_section->p_data;
  ...
  if(p_section->b_syntax_indicator)
  {
    ...
    while(p_byte < p_section->p_payload_end)
    {
      p_section->i_crc =   (p_section->i_crc << 8)
                         ^ DMA_s_crc32_table[(p_section->i_crc >> 24) ^ (*p_byte)];
      p_byte++;
    }
