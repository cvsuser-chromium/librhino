...
static dlna_profile_t avi_video={
	.id = NULL,
	.mime = MIME_VIDEO_AVI,
	.label = NULL
};
...
if(!strcmp (ctx->iformat->name,"avi"))
	return &avi_video;
...
dlna_registered_profile_t dlna_profile_av_mpeg4_part2 = {
  ...
  .class = DLNA_CLASS_AV,
  .extensions = "avi,mov,hdmov,mp4,3gp,3gpp,asf,mpg,mpeg,mpe,mp2t,ts,3g2",//add by lss avi
