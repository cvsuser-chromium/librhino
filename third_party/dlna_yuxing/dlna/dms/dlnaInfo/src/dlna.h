...
//dlna_profile_t *dlna_guess_pvr_info(dlna_t *dlna, const char *path, off_t *size, char **pvr_info,  PvrFInfo *pvr_key);
 ...
 */
 #if 0
char * dlna_write_protocol_info_ex (dlna_protocol_info_type_t type,
                                 ...
                                 dlna_profile_t *p);
#endif
int dlna_write_protocol_info_http (char *buf, int buf_len, 
                          dlna_org_flags_t flags,
                          dlna_profile_t *p);
