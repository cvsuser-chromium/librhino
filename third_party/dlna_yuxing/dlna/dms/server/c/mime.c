...
struct mime_type_t MIME_Type_List[] = {
  ...
  { "ts",    UPNP_VIDEO, "http-get:*:video/x-video-ts:"},
  ...
  { "idx", UPNP_TEXT, "http-get:*:text/idx:"}, /* DVD information */
...
//	{ "mpa",	UPNP_AUDIO, NULL},
	...
	{ "m4a",  UPNP_AUDIO, "http-get:*:audio/mp4:"},
#endif
//	{ "aac",	UPNP_AUDIO, "http-get:*:audio/vnd.dlna.adts:"},
//	{ "mp4",	UPNP_AUDIO, "http-get:*:audio/mp4:"},
		
	{ "wma",	UPNP_AUDIO, "http-get:*:audio/x-ms-wma:"},
	{ "wav",	UPNP_AUDIO, "http-get:*:audio/x-wav:"},
//	{ "flac",	UPNP_AUDIO, "http-get:*:audio/x-flac:"},

/* Video files */
	{ "ts",		UPNP_VIDEO, "http-get:*:video/vnd.dlna.mpeg-tts:"},
...
struct mime_type_t *getMimeType (const char *extension)
{
