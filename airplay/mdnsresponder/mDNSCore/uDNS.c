...
mDNSexport ZoneData *StartGetZoneData(mDNS *const m, const domainname *const name, const ZoneServiceEnum target, ZoneDataCallback callback, void *ZoneDataContext)
{
