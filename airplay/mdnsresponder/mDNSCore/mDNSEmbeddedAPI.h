...
struct ZoneData_struct
{
    ...
    ZoneServiceEnum ZoneService;            // Which service we're seeking for this zone (update, query, or LLQ)
...
extern ZoneData *StartGetZoneData(mDNS *const m, const domainname *const name, const ZoneServiceEnum target, ZoneDataCallback callback, void *callbackInfo);
...
//added by teddy.
extern const mDNSAddr AllLocalHost_v4;
