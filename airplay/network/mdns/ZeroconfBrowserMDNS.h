...
private:
  ...
  ///@{
  virtual bool doAddServiceType(const std::string& fcr_service_type) OVERRIDE;
  virtual bool doRemoveServiceType(const std::string& fcr_service_type) OVERRIDE;

  virtual std::vector<CZeroconfBrowser::ZeroconfService> doGetFoundServices() OVERRIDE;
  virtual bool doResolveService(CZeroconfBrowser::ZeroconfService& fr_service, double f_timeout) OVERRIDE;
  ///@}
